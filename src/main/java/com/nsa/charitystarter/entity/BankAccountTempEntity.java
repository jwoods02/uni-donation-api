 ...
 */
@Entity
@Table(name = "bank_account_temp", schema = "donations", catalog = "")
public class BankAccountTempEntity {
    private Integer id;
    private Integer charityId;
    private Integer accountNumber;
    private Integer sortCode;
    private String lastValidDay;
    ...
    @Basic
    @Column(name = "last_valid_day", nullable = true, length = 15)
    public String getLastValidDay() {
        return lastValidDay;
    }

    public void setLastValidDay(String lastValidDay) {
    ...
    public boolean equals(Object o) {
        ...
        BankAccountTempEntity that = (BankAccountTempEntity) o;
